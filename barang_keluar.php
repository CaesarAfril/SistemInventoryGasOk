  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      ...
      <div class="content p-4">
        <h1 class="display-5 mb-4">Barang Keluar</h1> <br>
        <div class="form_keluar">
          <form role="form" id="insertForm" method="POST" action="Controller/insertkeluar.php" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="tujuan_barang" id="tujuan_barang">
