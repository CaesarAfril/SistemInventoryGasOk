				...
				<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
					<form class="login100-form validate-form" action="ceklogin.php" method="post">
						<span class="login100-form-title p-b-33">
							SISTEM INVENTORY GUDANG GAS OK
						</span>
						<div class="wrap-input100 validate-input" data-validate = "Masukkan ID Gudang">
							<input class="input100" type="text" name="idgudang" placeholder="ID Gudang">
